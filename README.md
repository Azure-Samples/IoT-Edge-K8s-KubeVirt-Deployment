...
4. To create your own VM container image, you can use the dockerfile prepared [here](/deployment/Dockerfile) by running\
   *docker build [OPTIONS] PATH | URL | -*\
   and store it in your container registry or Docker Hub account.\
   Afterwards, you can reference this image in the HELM deployment file [aziot-edge-data-volume-container.yaml](/deployment/helm/templates/aziot-edge-data-volume-container.yaml)
